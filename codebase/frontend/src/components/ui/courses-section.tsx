  ...
  const courses = [
    {
      id: 1,
      image:
        "https://cdn.builder.io/api/v1/image/assets/TEMP/9dacc59a88ab1de3cfbd09224d46dbc85fed1dcb",
      price: "150",
      ...
      learners: "4,016 learners enrolled",
    },
    {
      id: 2,
      image:
        "https://cdn.builder.io/api/v1/image/assets/TEMP/a6ef79fda67f2a0e47ba5c604e61a7d65f0f21a4",
      price: "FREE",
                ...
                <div className="flex flex-col items-start gap-5 flex-1">
                  ...
                  <div className="flex px-1 items-center flex-wrap gap-3 w-full">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[#94A3B8] font-['Nunito'] text-xs font-normal leading-[14px]">
                        {course.modules}
                      </span>
                    </div>
